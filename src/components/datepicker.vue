                    ...
                    <v-card class="daterange--min-date">
                        ...
                        <v-card-text>
                            <v-alert :value="true" type="info">
                                In this example, you can only select dates within the last 15 days.
                            </v-alert>
                            <p>From:
                                <v-chip>{{ range[0] }}</v-chip>
                                To:
                ...
                <v-flex xs12>
                    <v-card class="daterange--dark">
                        ...
                        <v-card-text>
                            ...
                            <v-daterange dark :options="dateRangeOptions" @input="onDateRangeChange"/>
                        </v-card-text>
                    </v-card>
                </v-flex>
                <v-flex xs12>
                    <v-card class="daterange--dark">
                        ...
                        <v-card-text>
                            ...
                            <v-daterange next-icon="arrow_forward" prev-icon="arrow_back" :options="dateRangeOptions" @input="onDateRangeChange"/>
                        </v-card-text>
                    </v-card>
                </v-flex>
            </v-layout>
